...
<body>
	...
	<table id="header">
			<tr>
				...
				<th><a href = <%="\"quizHome.html?user="+name+"\""%>> Quizzes</a></th>
	...
	<%if(acct.isAdmin()) {%>
		<%out.println("<div id = \"admin-content\">"); %>
		<%out.println("<table id = \"admin_content\">");%>
		<%out.println("<tr>");%>
		<%out.println("<td>");%>
		...
		<%out.println("<textarea rows = \""+4+"\" cols = \""+50+"\" name = \"new_ancmnt\"></textarea>");%>
